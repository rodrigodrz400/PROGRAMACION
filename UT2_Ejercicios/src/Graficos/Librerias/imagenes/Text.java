...
public class Text implements Shape {
	 ...
	 * 
	 * @param x
	 *            the leftmost x-position of the shape
	 * @param y
	 *            the topmost y-position of the shape
	 * @param message
	 *            the text string
	 */
	...
	public int getWidth() {
		return (int) Math
				.round(label.getPreferredSize().getWidth() + 2 * xGrow);
	}
	...
	public int getHeight() {
		return (int) Math.round(label.getPreferredSize().getHeight() + 2
				* yGrow);
	}
	...
	public String toString() {
		return "Text[x=" + getX() + ",y=" + getY() + ",message="
				+ label.getText() + "]";
	}

	public void paintShape(Graphics2D g2) {
		if (color != null) {
			label.setForeground(new java.awt.Color((int) color.getRed(),
